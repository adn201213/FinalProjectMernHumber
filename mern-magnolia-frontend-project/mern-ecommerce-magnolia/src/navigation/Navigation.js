...
*/}
    ...
    {/* 
              ...
              <li  className="nav-item dropdown adnanNav1 active">
                ...
                <div className="dropdown-menu adnanNav1">
                  <a className="dropdown-item adnanNav1" href="/laptops">
                    Product
                  </a>
                  <a className="dropdown-item adnanNav1" href="/printers">
                    Offers
                  </a>
                  <a className="dropdown-item adnanNav1" href="/electronics">
                    Orders
                  </a>
                  <div className="dropdown-divider"></div>
                  <a className="dropdown-item adnanNav1" href="/mobiles">
                    Others
                  </a>
                </div>
              </li>
  ...
  {/* 
        <li>
          ...
          */}
          ...
          <NavLink onClick={auth.logout} to="/login" className="nav-link adnanNav1 active  ">
            LogOut
          </NavLink>
        </li>
...
*/}
            ...
            {auth.isLoggedIn && <div style={{color: 'white'}} className="adnanNav1 active">Hello {auth.loggedUser}</div>}
